...
const SuperadminPdc = () => {
    ...
    const handleSave = () => {
        const paymentStatus = paymentMethod === 'cash' ? 'paid' : 'pending'; // Determine payment status based on payment method
        ...
        if (paymentMethod === 'cash') {
            // If payment method is cash, set collection date to today's date
    ...
    filteredTenantData.forEach(tenant => {
        tenant.contractInfo.pdc.forEach(check => {
            if (!check.isTransfter && check.pdcstatus === 'return') {
            ...
            <Table striped bordered hover responsive>
                <thead style={{ backgroundColor: '#005f75' }}>
                    <tr>
                        ...
                        <th style={{ color: '#ffff' }}>Check Number</th>
            ...
            <Modal show={showModal} onHide={handleModalClose}>
                ...
                <form>
                    <Modal.Body>
                        ...
                        <div>
                            <label>Remarks:</label>
                            <input type="text" value={remarks} className="form-control" onChange={e => setRemarks(e.target.value)} />
                        </div>
