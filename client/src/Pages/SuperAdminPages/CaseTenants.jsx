...
const CaseTenants = () => {
    ...
    useEffect(() => {
        const fetchTenants = async () => {
            try {
                const response = await axios.get('/api/tenants/allcasetenants', {
                    headers: {
                ...
                <Col xs={12} sm={12} md={12} lg={10} xl={10} style={{ marginTop: '90px' }}>
                    <Row xs={1} md={2} lg={3}>
                        <Col xs={12} sm={12} md={12} lg={10} xl={10} >
                            <h2 className='text-center'>All Cases </h2>
                                            ...
                                            <tr key={tenant._id}>
                                                ...
                                                <td>
                                                    ...
                                                    <Link
                                                        ...
                                                        style={{ backgroundColor: '#301bbe', color: 'white', textDecoration: 'none', borderRadius: '10px', margin: '2px' }}
                                                        className='py-2 px-3'
                                                    >
                                                        Report
                                                    </Link>
