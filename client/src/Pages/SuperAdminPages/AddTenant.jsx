                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-md-4">
                                                    <div className="form-group">
                                                        ...
                                                        <select style={{ borderRadius: '8px', border: '1px solid #ebedf2' }} className='w-100 py-2' id="property" name="property" onChange={handlePropertyChange} value={formData.property}>
                                                ...
                                                <div className="col-md-4 ">
                                                    <div className="form-group">
                                                        ...
                                                        <select className='w-100 py-2' style={{ borderRadius: '8px', border: '1px solid #ebedf2' }} id="floor" name="floorId" value={formData.floorId} onChange={handleInputChange}>
                                                ...
                                                <div className="col-md-4">
                                                    <div className="form-group">
                                                        ...
                                                        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '10px' }} >
                                                            <select className='w-100 py-2' style={{ borderRadius: '8px', border: '1px solid #ebedf2' }} name="contractInfo.usage" value={formData.contractInfo.usage} onChange={handleInputChange}>
                                                    ...
                                                    {Array.from({ length: selectedUnitsCount }).map((_, index) => (
                                                        <div key={index}>
                                                            <div className="form-group"  >
                                                                ...
                                                                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '10px' }} >
                                                                    <select style={{ borderRadius: '8px', border: '1px solid #ebedf2' }} name={`unitId${index + 1}`} value={formData.unitId[index]} onChange={handleInputChange} className='w-100 py-2'>
                                                ...
                                                {formData.contractInfo.usage === 'commercial' ? null :
                                                    <div className="col-md-4">
                                                        <div className="form-group">
                                                            ...
                                                            <input style={{ borderRadius: '10px' }} type="text" className="form-control" name="name" placeholder="Tenant Name" value={formData.name} onChange={handleInputChange} />
                                                        </div>
                                                    </div>}
                                                ...
                                                {formData.contractInfo.usage === 'commercial' ? null :
                                                    <div className="col-md-4">
                                                        <div className="form-group">
                                                            ...
                                                            <input style={{ borderRadius: '10px' }} type="text" className="form-control" name="passport" placeholder="Passport" value={formData.passport} onChange={handleInputChange} />
                                                        </div>
                                                    </div>}
                                                ...
                                                {formData.contractInfo.usage === 'commercial' ? null :
                                                    <div className="col-md-4">
                                                        <div className="form-group">
                                                            ...
                                                            <input style={{ borderRadius: '10px' }} type="text" className="form-control" name="nid" placeholder="Emirates ID No." value={formData.nid} onChange={handleInputChange} />
                                                        </div>
                                                    </div>
                                                }
                                            </div>
                                            ...
                                            <div className="row">
                                                <div className="col-md-3">
                                                    <div className="form-group">
                                                        ...
                                                        <input style={{ borderRadius: '10px' }} type="number" className="form-control" name="contractInfo.VAT" placeholder="VAT %" value={formData.contractInfo.VAT} onChange={handleInputChange} required />
                                                    </div>
                                                </div>
                                                <div className="col-md-3">
                                                    <div className="form-group">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-md-3">
                                                    <div className="form-group">
                                                        ...
                                                        <input style={{ borderRadius: '10px' }} type="number" className="form-control" name="contractInfo.graceperiod" placeholder="Grace Period" value={formData.contractInfo.graceperiod} onChange={handleInputChange} />
                                                    </div>
                                                </div>
                                            ...
                                            {checkDetails.map((check, index) => (
                                                <div key={index}>
                                                    <div className="row">
                                                        <div className="col-md-3 ">
                                                            <div className="form-group">
                                                                <input style={{ borderRadius: '10px' }} type="text" className="form-control" placeholder="Bank" value={check.bank} onChange={(e) => handleCheckDetailChange(index, 'bank', e.target.value)} />
                                                            </div>
                                                        </div>
                                                        <div className="col-md-3 ">
                                                            <div className="form-group">
                                                                <input style={{ borderRadius: '10px' }} type="text" className="form-control" placeholder="Check Number" value={check.checkNumber} onChange={(e) => handleCheckDetailChange(index, 'checkNumber', e.target.value)} />
                                                            </div>
                                                        </div>
                                                        <div className="col-md-3">
                                                            <div className="form-group">
