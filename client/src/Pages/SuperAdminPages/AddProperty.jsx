                                            ...
                                            <Card.Body>
                                                ...
                                                <div className='row' >
                                                    ...
                                                    <div className="mb-3 col-md-3">
                                                        ...
                                                        <input style={{ borderRadius: '10px' }} type="text" className="form-control" name="plotNo" value={formData.plotNo} onChange={handleChange} required />
                                                    </div>
                                                    <div className="mb-3 col-md-3">
                                                    ...
                                                    <div className="mb-4 col-md-3">
                                                        ...
                                                        <input style={{ borderRadius: '10px' }} type="text" className="form-control" name="propertyNo" value={formData.propertyNo} onChange={handleChange} required/>
                                                    </div>
                                                    <div className="mb-3 col-md-3" >
