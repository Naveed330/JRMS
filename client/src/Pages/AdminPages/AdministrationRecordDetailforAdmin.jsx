...
const AdministrationRecordDetailforAdmin = () => {
                                ...
                                <tbody>
                                    <>
                                        <tr>
                                            ...
                                            <td> {`${adminstractionRecordDetails?.tenantId?.contractInfo?.monthsDuration && adminstractionRecordDetails?.tenantId?.contractInfo?.monthsDuration} Months`} </td>
...
export default AdministrationRecordDetailforAdmin