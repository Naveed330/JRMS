...
const FinancialReportForAdmin = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // Fetch property data
                const propertyResponse = await axios.get('/api/properties/allpropertiesforadmin', {
                    headers: {
                ...
                // Fetch tenant data
                const tenantResponse = await axios.get('/api/tenants/alltenantsforadmin', {
                    headers: {
                        Authorization: `Bearer ${state.user.token}`,
                    },
                });
...
export default FinancialReportForAdmin;