...
import PropertySearchForAdmin from '../../Components/PropertySearchForAdmin'
...
const AllPropertiesForAdmin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`/api/properties/propertyforadmin/edit/${editData._id}`, editData, {
                headers: {
                    Authorization: `Bearer ${state.user.token}`,
                },
            });
                                    ...
                                    <>
                                        ...
                                        <div style={{ display: 'flex', justifyContent: 'space-evenly', alignItems: 'center', flexWrap: 'wrap' }} >
                                            {properties.map(property => {
                                                return (
                                                    <>
                                                        <Card className='mt-4 mb-5' style={{ width: '25rem', height: '28rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)' }}>
