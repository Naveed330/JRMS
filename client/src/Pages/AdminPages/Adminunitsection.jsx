...
const AdminUnit = () => {
  ...
  const handleAddUnit = async () => {
    try {
      const response = await axios.post(`/api/properties/unitforadmin/${selectedFloorId}/addUnit`, {
        type: unitType,
        occupied,
        premiseNo,
        unitRegNo,
      ...
      const updatedProperties = await axios.get('/api/properties/allpropertiesforadmin', {
        headers: {
          Authorization: `Bearer ${state.user.token}`
        }
      });
  ...
  const handleEditUnit = async () => {
    try {
      const response = await axios.put(`/api/properties/unitforadmin/${editFloorId}/editUnit/${editUnitId}`, {
        name: editUnitName,
        type: editUnitType,
  ...
  const handleDeleteUnit = async (floorId, unitId) => {
    try {
      ...
      const updatedProperties = await axios.get('/api/properties/allpropertiesadmin', {
        headers: {
          Authorization: `Bearer ${state.user.token}`
        }
      });
