...
import FloorSearchAdmin from '../../Components/FloorSearchAdmin';
...
const AdminFloor = () => {
    ...
    const handleAddFloor = async () => {
        ...
        try {
            const response = await axios.post(`/api/properties/floorforadmin/${selectedApartmentId}/addFloor`, { name: floorName }, {
                headers: {
                    Authorization: `Bearer ${state.user.token}`
                }
            });
    ...
    const handleEditFloor = async () => {
        try {
            const response = await axios.put(`/api/properties/floorforadmin/${editFloorId}`, { name: editFloorName }, {
                headers: {
                    Authorization: `Bearer ${state.user.token}`
                }
            });
