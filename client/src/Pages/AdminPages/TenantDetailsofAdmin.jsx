...
const TenantDetailsofAdmin = () => {
    ...
    useEffect(() => {
        const fetchTenantDetails = async () => {
            try {
                ...
                const response = await axios.get(`/api/tenants/tenantforadmin/${id}`, {
                    headers: {
    ...
    console.log(property, 'propertytenants');
    return (
        <div>
            <Row>
...
export default TenantDetailsofAdmin;