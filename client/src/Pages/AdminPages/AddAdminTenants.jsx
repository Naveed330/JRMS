...
const AddAdminTenants = () => {
    ...
    const handleInputChange = (e) => {
        ...
        if (name.startsWith("contractInfo.")) {
            ...
            console.log(`Updating unitId at index ${index} to value ${value}`); 
        ...
        setFormData({
            ...
            contractInfo: {
                ...
                difference: (updatedFormData.contractInfo.totalContractAmount - finalAmount).toFixed(2) 
            }
        });
    };
    ...
    const handleParkingChange = (e) => {
        ...
        const parkingSelected = value === "true"; 
        setFormData(prevState => ({
            ...prevState,
            contractInfo: {
            ...
            parkingValue: parkingSelected ? formData.parkingValue : "", 
                                            ...
                                            {formData.contractInfo.parking && (
                                                ...
                                                {/* <div className="col-md-3">
                                                    <div className="form-group">
                                                        ...
                                                        <input style={{ borderRadius: '10px' }} type="number" className="form-control" name="contractInfo.numberofoccupants" placeholder="Number of Occupants" value={formData.contractInfo.numberofoccupants} onChange={handleInputChange} required/>
                                                    </div>
                                                </div> */}
                                                <div className="col-md-3">
                                                    <div className="form-group">
