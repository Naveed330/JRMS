...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.post('/api/users/registerforadmin', formData, {
        headers: {
          ...
          <Row xs={1} md={2} lg={3}>
            <Col xs={12} sm={12} md={12} lg={10} xl={10} >
              ...
              <div className="py-2 px-5" style={{ boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)' }}>
                <Card>
                  <div className="h4 bold text-center text-uppercase" style={{ marginTop: '60px' }}>
                    <h3>Add Owner OR User</h3>
                  </div>
