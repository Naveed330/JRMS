...
import GenerateReport from './Pages/SuperAdminPages/GenerateReport.jsx';
import Income from './Pages/SuperAdminPages/Income.jsx';
import JoveraIncome from './Pages/SuperAdminPages/JoveraIncome.jsx';
import RenewalContract from './Pages/SuperAdminPages/RenewalContract.jsx';
import TenantReport from './Pages/SuperAdminPages/TenantReport .jsx';
import CaseTenants from './Pages/SuperAdminPages/CaseTenants.jsx';
    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/generatereport" element={<SuperAdminRoute ><GenerateReport /></SuperAdminRoute>} />
          <Route path="/income" element={<SuperAdminRoute ><Income /></SuperAdminRoute>} />
          <Route path="/joveraincome" element={<SuperAdminRoute ><JoveraIncome /></SuperAdminRoute>} />
          <Route path="/renewalcontract/:id" element={<SuperAdminRoute ><RenewalContract /></SuperAdminRoute>} />
          <Route path="/tenantreport/:id" element={<SuperAdminRoute ><TenantReport /></SuperAdminRoute>} />
          <Route path="/allcasetenant" element={<SuperAdminRoute ><CaseTenants /></SuperAdminRoute>} />
